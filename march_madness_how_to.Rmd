...
See my [short scraping script](scripts/scrape_preseason_ranks.R), which grabs the pre-season rankings for each year and then combines them into a single tidy table.  It's pretty simple; just remember to use SelectorGadget when scraping with rvest, to make sure you target the desired nodes.